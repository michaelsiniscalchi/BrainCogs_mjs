...
params.encoding.modelName           = ["allCues","posXcueSide"]; %"FM_cueTypeXpos"; %"FM_cueTypeXpos" "posXcueSide_pos","only_posXcueSide", "only_posXcueType", 'firstCuesRewVelPos' 'only_position' "FM" 
