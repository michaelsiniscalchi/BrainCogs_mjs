...
params.encoding.modelName           = ["FM", "FM_noAllCues", "FM_cueTypeXpos","only_posXcueType", "posXcueSide_pos","only_posXcueSide"]; %"only_posXcueSide", "only_posXcueType", 'firstCuesRewVelPos' 'only_position' "FM" 
