...
for j = 1:numel(fileList)
    ...
    cells.reserve(j) = isempty(S.cellf) & sum(S.bw,"all")==0; %Exclusion masks generated by 'cellROI.m' are coded with cellf = [].
    cells.exclude(j) = isempty(S.cellf) & sum(S.bw,"all")>0; %Exclusion masks generated by 'cellROI.m' are coded with cellf = [].
end
