...
matfiles = ["mjs20_018","mjs20_173","mjs20_175","mjs20_177","mjs20_199",...
    "mjs20_569","mjs20_570","mjs20_571","mjs20_572","mjs20_834","mjs20_32","mjs20_33"];
nSwitches = [0,0,0,0,1,...
    0,2,2,1,1,1,2]; %Counted manually
...
for i = 1:numel(subjects)
    ...
    if any(rule=="tactile") && any(rule=="visual")
...
fig = figure('Name','SessionsToCriterion_Ai148','Position',[300 300 1000 400]);
