...
ruleColors = {'all',cbrew.black,'tactile',cbrew.purple,'tactile2',cbrew.purple2,...
    'visual',cbrew.blue,'visual2',cbrew.blue2,'pooled',cbrew.gray,'pooled2',cbrew.gray2,...
...
regressionColors = {'bias',cbrew.gray};
kinematicsColors =...
    {'heading', cbrew.black, 'position',cbrew.black,...
    'speed',cbrew.black,'velocity',cbrew.black,'acceleration',cbrew.black};
dataColors = {'data',cbrew.black,'data2',cbrew.gray,...
    'time',cbrew.black,'trialIdx',cbrew.black,'ITI',cbrew.black,'B0',cbrew.black};
colors = struct(choiceColors{:}, ruleColors{:}, outcomeColors{:}, regressionColors{:},...
