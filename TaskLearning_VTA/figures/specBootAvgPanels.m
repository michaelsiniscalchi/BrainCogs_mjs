...
% ax(i).comparison    = "cueRegion-puffCount";
% ax(i).trigger       = "cueRegion";
% ax(i).trialType     = ["noPuffs","loPuffs","hiPuffs"];
% ax(i).window        = [-inf, inf];
% ax(i).color         = {colors.data2, colors.tactile2, colors.tactile}; %Choice: left/hit/sound vs right/hit/sound
% ax(i).lineStyle     = {'-','-','-'};
% ax(i).xLabel        = 'Distance (cm)';  % XLabel
% i=i+1;
% 
% ax(i).title         = "Towers";
% ax(i).comparison    = "cueRegion-towerCount";
% ax(i).trigger       = "cueRegion";
% ax(i).trialType     = ["noTowers","loTowers","hiTowers"];
% ax(i).window        = [-inf, inf];
% ax(i).color         = {colors.data2, colors.visual2, colors.visual};
% ax(i).lineStyle     = {'-','-','-'};
% ax(i).xLabel        = 'Distance (cm)';  % XLabel
% i=i+1;
