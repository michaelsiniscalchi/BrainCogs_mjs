...
ax(i).comparison   = 'first-tower';
ax(i).trigger   = "firstTower";
ax(i).trialType = ["leftPuffs_loTowers", "rightPuffs_loTowers"];
ax(i).window    = [-1, 3];
ax(i).color      = {colors.left,colors.right}; 
ax(i).lineStyle  = {'-','-'};
ax(i).xLabel = 'Time from first cue (s)';  % XLabel
...
ax(i).comparison   = 'first-tower';
ax(i).trigger   = "firstTower";
ax(i).trialType = ["leftPuffs_hiTowers", "rightPuffs_hiTowers"];
ax(i).window    = [-1, 3];
ax(i).color      = {colors.left,colors.right}; 
ax(i).lineStyle  = {'-','-'};
ax(i).xLabel = 'Time from first cue (s)';  % XLabel
