...
ax(i).trigger   = "outcome";
ax(i).trialType = ["loTowers_correct", "hiTowers_correct"];
ax(i).window    = [-1, 3];
ax(i).color      = {colors.correct2, colors.correct}; 
ax(i).lineStyle  = {'-','-'};
...
ax(i).comparison   = "towerCount-outcome";
ax(i).trigger   = "outcome";
ax(i).trialType = ["loTowers_error", "hiTowers_error"];
ax(i).window    = [-1, 3];
ax(i).color      = {colors.correct2, colors.correct}; 
ax(i).lineStyle  = {'-','-'};
ax(i).xLabel = 'Time from first cue (s)';  % XLabel
...
ax(i).trigger   = "outcome";
ax(i).trialType = ["loPuffs_correct", "hiPuffs_correct"];
ax(i).window    = [-1, 3];
ax(i).color      = {colors.correct2, colors.correct}; 
ax(i).lineStyle  = {'-','-'};
ax(i).xLabel = 'Time from first cue (s)';  % XLabel
...
ax(i).comparison   = "puffCount-outcome";
ax(i).trigger   = "outcome";
ax(i).trialType = ["loPuffs_error", "hiPuffs_error"];
ax(i).window    = [-1, 3];
ax(i).color      = {colors.err2, colors.err}; 
ax(i).lineStyle  = {'-','-'};
ax(i).xLabel = 'Time from first cue (s)';  % XLabel
i=i+1;
