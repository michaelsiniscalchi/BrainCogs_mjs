...
for i = 1:numel(subjects)
    ...
    for j = 1:numel(sessionDate)
        ...
        sessions(numel(sessionDate),1) = struct(...
            ...
            'pStuck', [],...
            'meanLicksTowers', [], 'meanLicksPuffs', [], 'meanLicksReward', [],...
        ...
        for k = 1:numel(logs.block)
            ...
            %Mean Lick Counts
            meanLicksTowers(k) = mean(nLicksCue(visualCS & blockIdx==k));
            meanLicksPuffs(k) = mean(nLicksCue(tactileCS & blockIdx==k));
        ...
        sessions(j) = struct(...
            ...
            'pStuck', pStuck,...
            'meanLicksTowers', meanLicksTowers,...
            'meanLicksPuffs', meanLicksPuffs,...
